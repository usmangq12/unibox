...
const PrivacyPolicy = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="mb-4">Last updated: July 21, 2024</p>
      <p className="mb-4">
        This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
      </p>
      <p className="mb-4">
        We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-500">Privacy Policy Generator</a>.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to unibox.</p>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <p><strong>Website</strong> refers to unibox, accessible from <a href="http://localhost:3000" rel="external nofollow noopener" target="_blank" className="text-blue-500">http://localhost:3000</a></p>
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">By email: usmangq12@gmail.com</li>
      </ul>
    </div>
  );
};
